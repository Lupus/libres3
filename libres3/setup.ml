...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8fdb19a8d5c7ed84b27d8a5af01b3da8) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_data_files =
                        [
                           ...
                           ("../files/info.log", Some "$localstatedir/log/");
                           ("../../README", Some "$docdir/");
                           ("../../COPYING", Some "$docdir/");
                           ("../files/libres3.pid",
                             Some "$localstatedir/run/")
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\212\b\015\b\156\147\192/\018Tu\181\217;Z\198";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
