...
(* OASIS_START *)
(* DO NOT EDIT (digest: e2d677b0677ddeff199cf6c932e7ea44) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          findlib_version = Some (OASISVersion.VGreaterEqual "1.2.8");
                    ...
                    (OASISExpr.EBool true,
                      Some
                        (("chmod",
                           [
                              "+x";
                              "src/files/sbin/libres3";
                              "src/files/sbin/libres3_certgen";
                              "src/files/s3genlink.py"
                           ])))
                 ]
            };
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Http"; "Caching"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "sxclient"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                  ...
                  },
                   {
                      ...
                      bs_data_files =
                        [
                           ...
                           ("../files/sbin/libres3_certgen",
                             Some "$sbindir/");
                           ("../files/s3genlink.py", Some "$docdir/");
                           ("../files/info.log",
                             Some "$localstatedir/log/libres3/");
                           ("../../README", Some "$docdir/");
                           ("../../COPYING", Some "$docdir/");
                           ("../../doc/manual/manual.pdf", Some "$docdir/")
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "libres3_report.ml"});
               Executable
                 ({
                     cs_name = "server_test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "sigv4Test.ml"});
               Executable
                 ({
                     cs_name = "randgen";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "randgen.ml"});
               Test
                 ({
                     cs_name = "misc";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\012\237Y|o.q\167\243\212\156\200\031k}\225";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
