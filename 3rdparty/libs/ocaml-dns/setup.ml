...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7a290015bf6c5e7da89610bf658e7a31) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Async library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dns_resolver_mirage"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dns";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "dns";
                           FindlibPackage ("core.syntax", None);
                   ...
                   {
                      lib_modules =
                        ["Async_dns_resolver"; "Async_dns_resolver_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dns";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "lib_test/async";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("async", None);
                           InternalLibrary "dns-async"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_async_dns_resolver_unix.ml"
                   });
               Executable
                 ({
                     cs_name = "test";
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "lib_test/ounit";
                      test_run =
                        [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "H\243\015^I\193\242+\143\128\21981\179\0155";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
